...
- [x] 5.6 Desktop regression smoke via `bun run wt:dev`: window, tray, and menus behave as before and no install affordance appears (`web-app-install`: *The Install Surface Is Inert in the Desktop Shell*)
